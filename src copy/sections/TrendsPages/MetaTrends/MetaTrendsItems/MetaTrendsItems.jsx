...
const ProjectItems = () => {
  ...
  return (
    ...
    <>
      <div className="container md:!max-w-[100%]">
        {/* <br />
        <TrendFilters
        ...
        /> */}
        <div className="projects-row md mt-3">
          <div>
            {/* TABS START */}
            <div className="flex justify-center items-center text-sm font-medium text-center w-full text-gray-200">
              <ul
                className="flex flex-wrap w-full justify-center bg-[linear-gradient(90deg,_rgba(36,34,62,0)_0%,_rgba(27,26,50,1)_40%,_rgba(27,26,50,1)_60%,_rgba(36,34,62,0)_100%)]
"
              >
                <li
                  className="me-2 bg-[#24223e]"
                  onClick={() => setActiveTab("Champions")}
                >
                  <div
                    className={`inline-block py-4 px-4 text-[18px] ${
                      activeTab === "Champions"
                        ? "text-[#fff] border-b-4 border-[#fff] active"
                        : "border-transparent"
                    } border-b-4 rounded-t-lg hover:text-blue-500 hover:border-blue-500 cursor-pointer`}
                  >
                    {others?.champions}
                  </div>
                </li>
                ...
                <li className="me-2" onClick={() => setActiveTab("Items")}>
                  <div
                    className={`inline-block py-4 px-4 text-[18px] ${
                      activeTab === "Items"
                        ? "text-[#fff] border-b-2 border-[#fff] active"
                        : "border-transparent"
                    } border-b-4 rounded-t-lg hover:text-blue-500 hover:border-blue-500 cursor-pointer`}
                    aria-current="page"
                  >
                    ...
                    <div className={`${isClosed[i] ? "hidden" : ""}`}>
                      ...
                      >
                        <div className="flex min-h-[150px] flex-col justify-between items-center bg-[#27282E] py-[16px] lg:flex-row lg:gap-[15px] bg-transparent lg:py-[0px] xl:pr-[24px]">
                                  ...
                                  >
                                    ...
                                    <div className="inline-flex items-center justify-center flex-col">
                                      ...
                                      <div className="inline-flex flex-col">
                                        ...
                                        {/* <p
                                          className="ellipsis text-center text-[11px] md:text-[18px] leading-[14px] text-[#808080] font-extralight absolute bottom-1
                          ...
                          <div className="mb-[12px] mt-[12px] grid w-full grid-cols-3 md:grip-cols-4 gap-[12px] sm:w-auto md:mb-0 md:!flex md:items-center">
                                ...
                                options={{
                                  ...
                                  plugins: {
                                    ...
                                    tooltip: {
                                      enabled: true,
                                      bodyFont: {
                                        size: 26, // Specify the font size for tooltip body text
                                      },
                                      titleFont: {
                                        size: 26, // Specify the font size for tooltip title text
                                      },
                                    },
                                  },
                                }}
