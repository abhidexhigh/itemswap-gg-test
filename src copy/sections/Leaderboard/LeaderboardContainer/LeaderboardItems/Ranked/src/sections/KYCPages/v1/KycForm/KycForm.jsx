  ...
  return (
    <KycFormStyleWrapper>
      <div className="kyc_form">
        ...
        <div
          className={`kyc_country_dropdown_sect ${isContryList ? "active" : ""}`}
        >
          <div
            className="kyc_country_dropbox"
            onClick={() => setCountryList(!isContryList)}
          >
            <span>
              <img src={flagIcon.src} alt="flag" className="img-fluid" />
            </span>
            <h4>United States</h4>
          </div>
        ...
        <div className="kyc_radio_sect">
          ...
          >
            ...
            <div className="kyc_icon">
              <img src={licenceIcon.src} alt="icon" className="imf-fluid" />
            </div>
          </div>
        </div>
