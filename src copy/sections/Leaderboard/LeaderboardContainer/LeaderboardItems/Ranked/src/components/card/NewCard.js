...
export default function NewCard({ image }) {
  ...
  return (
    <div
      //   ref={containerRef}
      className="relative w-full max-w-[104px] aspect-[1/1] rounded-lg overflow-hidden"
    >
      {/* Particle canvas */}
      <canvas
        // ref={canvasRef}
      ...
      <div className="relative z-20 h-full flex flex-col">
        ...
        <div className="relative flex-1 overflow-hidden">
          ...
          {/* Character frame overlay */}
          <Image
            src="https://res.cloudinary.com/dg0cmj6su/image/upload/v1744371801/character_frame_rv7l87.png"
            alt="Character Frame"
            fill
