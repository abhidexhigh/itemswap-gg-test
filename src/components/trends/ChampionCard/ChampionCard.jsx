...
/**
 * Common utility function to get random characters
...
// Common coin icons used by both components
const coinIcons = [
...
/**
 * ChampionCard - A reusable component for displaying champion cards
 * Used by both MetaTrends and RecentDecks components
 */
const ChampionCard = ({
  championsByCost,
  ...
  selectedChampion,
  forces,
  componentType = "meta", // 'meta' or 'recent' to differentiate if needed
}) => {
  return (
